...
class HeaderMenu extends Component {
  ...
  HomeNavigation() {
    return (
      <View style={styles.headerContainer}>
        ...
        >
          <Image
            source={require("../Assets/Image/Shaloom-Razade.jpeg")}
  ...
  AddNoteNavigation() {
    return (
      <View style={styles.headerContainer}>
        ...
        <TouchableOpacity
          onPress={this.props.navigation.getParam("insertNote")}
          style={styles.rightHeader}
        >
  ...
  EditNoteNavigation() {
    return (
      <View style={styles.headerContainer}>
        ...
        <TouchableOpacity
          onPress={this.props.navigation.getParam("updateNote")}
          style={styles.rightHeader}
        >
          <FontAwesomeIcon icon={faCheck} color={"#2ED1A2"} size={22} />
        </TouchableOpacity>
  ...
  render() {
    return this.props.screen == "Home"
      ? this.HomeNavigation()
      : this.props.screen == "AddNote"
      ? this.AddNoteNavigation()
      : this.props.screen == "EditNote"
      ? this.EditNoteNavigation()
      : null;
  }
}
